...
// TODO: export error check this fix now /admin/orders is not fetching data from db
function initAdmin() {
  ...
  // another function that is dependent for rendering item objects in their real names
  ...
  // Markup format to display orders in admin panel
...
function updateCart(gear) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/update-cart", gear).then(function (res) {
    // console.log(res);
...
addToCart.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var gear = JSON.parse(btn.dataset.gears);
    updateCart(gear);
  });
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkgearx"] = self["webpackChunkgearx"] || [];
